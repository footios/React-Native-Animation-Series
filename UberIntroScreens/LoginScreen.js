...
class LoginScreen extends Component {
  constructor(props) {
    super();
    this.state = {
      placeholderText: "Αριθμός κινητού τηλεφώνου..."
    };
  }
  ...
  increaseHeightOfLogin = () => {
    this.setState({ placeholderText: "6988833888" });
  ...
  decreaseHeightOfLogin = () => {
    this.setState({ placeholderText: "Αριθμός κινητού τηλεφώνου..." });
    Keyboard.dismiss();
    Animated.timing(this.loginHeight, {
      toValue: 150,
      duration: 700
        ...
        >
          ...
          <Animatable.View animation="slideInUp" iterationCount={1}>
            ...
            >
              ...
              >
                <Text style={{ fontSize: 24 }}>
                  Γνωριμία με τον Κύριο ημών Ιησού Χριστό.
                </Text>
              </Animated.View>
            ...
            >
              ...
              >
                Συνδεθείτε με λογαριασμό κοινωνικής δικτύωσης
              </Text>
            </View>
          </Animatable.View>
        </ImageBackground>
