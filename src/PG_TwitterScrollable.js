...
const PG_TwitterScrollable = () => {
  ...
  const rotateImageStyle = scrollY.interpolate({
    inputRange: [0, 100], // if you leave it at 1 the image spins too much
      ...
      >
        <Animated.View
          style={{
            ...
            marginLeft: 10,
            transform: [{ rotate: rotateImageStyle }]
          }}
        >
          <Image
...
export default PG_TwitterScrollable;
